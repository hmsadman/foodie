...
<li><a href="contact_us.html">Contact Us</a>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="sign_up.html">Sign Up</a>
    ...
    <div class="col-md-4">
    <form class="form-inline" role="form" class="pagination-centered">
    <div class="form-group" >
          <input type="text"  size="100" class="form-control" id="search" placeholder="Enter Area and City">
          <button type="submit" class="btn btn-xl btn-danger"> Find Restaurants</button>
        </div>
    </form>
    </div>
    ...
    <script src="vendor/bootstrap/bootstrap-dropdownhover.min.js"></script>
